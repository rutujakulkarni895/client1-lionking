...
; (function () {
	...
	jQuery(document).ready(function ($) {
		...
		if ($o.r) {
			...
			$('[href="minify/ckav_min.css"]').attr('href', 'minify/ckav_mind41d.html?'+ckav.uid());
			...
			if ($o.countbox) {
				var counterup_script_arr = [
					...
					"lib/counter-up/jquery.counterup.min.html"
				];
			...
			if ($o.socialsection) {
				...
				ckav.getMultiScripts(social_script_arr, 'lib/social-feed/index.html').done(function () {
